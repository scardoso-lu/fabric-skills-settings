...
Notebooks submitted via `fabric-vibe notebook deploy` run as a Service Principal. Fabric's MLflow plugin calls a backend "Mwc" service that rejects SPN tokens:
