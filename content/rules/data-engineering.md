...
Use the `fabric-validate` skill for independent DQ notebook authoring and tester validation.
...
Use the `fabric-transform` skill for Silver/Gold Spark transformations and MERGE patterns.
